...
namespace spp2pgs
{
	...
	{
	public:
		Win32StreamEx(HANDLE handle, bool canRead, bool canWrite, bool canSeek, TimeoutManager *timeoutManager);
		~Win32StreamEx() {};
		...
		void Write(unsigned char const * buffer, int index, int length);
