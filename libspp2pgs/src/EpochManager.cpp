...
namespace avs2pgs
{
	...
	EpochManager::EpochManager(A2PContext const * context, BdViFrameRate frameRate, Size frameSize) :
		A2PControllerBase(context), minInterval((int)avs2pgs::GetFrameTimeStamp(1, frameRate)), frameSize(frameSize),
